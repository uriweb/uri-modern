...
* Removes stretchy paragraph and heading block variations for WP 6.9.x
* Reveals search submit button for screenreaders
* Makes Promo component admin only
* Removes HTML editing access from non-admins
