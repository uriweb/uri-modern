...
URI Modern 1.2.10 is a bug fix release.

* Fixes an issue that caused non-link titles generated by [Display Posts Shortcode](https://github.com/billerickson/display-posts-shortcode) to have a link-like hover state
* Updates development tools

For complete details, see the [commit history](https://github.com/uriweb/uri-modern/pull/160/commits) and the [issue tracker](https://github.com/uriweb/uri-modern/issues).
